 ...
 * @author Putri Ayu
 */
public class Roomss extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Roomss.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
